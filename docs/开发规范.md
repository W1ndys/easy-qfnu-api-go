...
| 技术         | 说明                       | CDN 引入方式                                                    |
| ------------ | -------------------------- | --------------------------------------------------------------- |
| TailwindCSS  | CSS 框架                   | `<script src="https://cdn.tailwindcss.com"></script>`          |
| Vant         | 移动端组件库               | `<link rel="stylesheet" href="https://unpkg.com/vant@4/lib/index.css">` + `<script src="https://unpkg.com/vant@4/lib/vant.min.js"></script>` |
...
request.interceptors.response.use(
    ...
    error => {
        vant.showToast({ message: '网络错误，请稍后重试', type: 'fail' });
...
async function handleQuery() {
    ...
    // 显示加载
    vant.showLoadingToast({ message: '查询中...', forbidClick: true });
